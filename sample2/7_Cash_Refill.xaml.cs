...
{
    /// <summary>
    /// Interaction logic for _7_Cash_Refill.xaml
    /// </summary>
    public partial class _7_Cash_Refill : Page
    {
        ...
        public _7_Cash_Refill(_6_Menu _6_Menu)
        {
            InitializeComponent();
            ...
            StartClock();
            this.BalanceAmountTxt.Text = "" + SqliteChange.getBalance("ND", Sqlitedatavr.getBillDenomination());
            int Cash_deno = 1;
            int convert1 = Cash_deno * Sqlitedatavr.getBillDenomination();
            DenominationTxt.Text = convert1.ToString();
        }
        ...
        {
            this.Time.Text = indianTime.ToString();
        }
        ...
        private void Save(object sender, RoutedEventArgs e)
        {
            ...
            {
                success = SqliteChange.InsertIntoCurrencyTransactionTable(Int32.Parse(this.DenominationTxt.Text), this.InvoiceReqTxt.Text,
                    Int32.Parse(this.AdditionalCountTxt.Text), formatdate, this.UserNameTxt.Text,  //imthi 20-01-2021
                    this.TransactionTypeTxt.Text, Int32.Parse(this.BalanceAmountTxt.Text),
                    Int32.Parse(this.FinalBalanceAmountTxt.Text), "ND", "Completed");
            }
            ...
            {
                noti.ShowError("Please Fill the data!");
                //MessageBox.Show("Please Fill the Box Correctly!");
            }
            this.NavigationService.Navigate(new _7_Cash_Refill(_6_Menu));
        }
        ...
        private void AdditionalCountTxt_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (this.TransactionTypeTxt.Text == "Credit")
            {
                if (AdditionalCountTxt.Text != "")
                {
                    ...
                    Int32 b = a * Sqlitedatavr.getBillDenomination();
        ...
        private void gotoCashAcceptorPage(object sender, RoutedEventArgs e)
        {
            this.NavigationService.Navigate(new _15_Cash_Acceptor_Log(this));
        }
    }
}
